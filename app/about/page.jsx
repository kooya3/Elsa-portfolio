    ...
    >
      <div className="lg:p-6 p-5">
        ...
        <div>
          ...
          >
            I am Elsarita Njoki Oulie, a dedicated and organized individual with good collaborative skills. I am seeking a job that will allow me to make the best use of my skills and further develop them. I have a genuine interest in the transport/logistics industry and consider my strengths to be long-term planning skills and the ability to complete tasks within deadlines. I am a team player who thrives in collaboration with others and contributes to a positive and pleasant working environment. I also have a strong sense of social responsibility and am involved in the Red Cross. My outdoor activities include skiing, cycling, sailing, and participating in triathlons.
          </motion.p>
        </div>
        ...
        <div>
          ...
          <motion.p
            ...
            className="text-neutral-700 text-lg my-7 leading-8 font-InterRe dark:text-[#C0C0C0]"
          >
            When I'm not immersed in my work in the IT field, I find solace in outdoor activities such as skiing, cycling, sailing, and participating in triathlons. I believe in maintaining a healthy work-life balance and understand the importance of taking breaks and reenergizing my mind and body. In my spare time, I also volunteer at the Red Cross, contributing to society and helping those in need. Additionally, I enjoy exploring nature and spending time with animals, which aligns with my passion for outdoor activities and my involvement in the Red Cross.
          </motion.p>
