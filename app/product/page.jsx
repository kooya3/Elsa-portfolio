      ...
      <div className=" lg:p-6 p-4 max-md:p-5 ">
        ...
        <div className=" mt-7 md:px-6 p-2 ">
          ...
          <p className="text-neutral-700 text-base my-7 leading-8 font-InterRe dark:text-[#C0C0C0]">
            Hi, I'm Elsarita Njoki Oulie, Here is my dedicated  where purposeful commitment meets captivating design. My work strives to enhance experiences and inspire.
           {/*  
